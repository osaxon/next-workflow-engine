import { type TextMessageNodeData } from "~/components/flow-builder/components/blocks/nodes/text-message-node/text-message.node";
import { type BuilderNodeType } from "~/components/flow-builder/components/blocks/types";
